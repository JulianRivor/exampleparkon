...
import org.imasd.webapp.domain.web.PersonaController;
...
privileged aspect PersonaController_Roo_Controller {
    ...
    void PersonaController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("persona_fechadenacimiento_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
